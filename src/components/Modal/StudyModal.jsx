      ...
      <div className="study-modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="study-modal-body">
          <div className="study-modal-text">
            ...
            <p>
              Kaabil Helps You Get Your Own Private 
              Tutor In Depth Learning Insights, Build And 
              Share Virtual Tests Simultaneously, Get Best 
              Practice Questions And Answers, And Get A 
              Custom Lesson Plan—Complete With Kaabil 
              TAs Explanations On Your Virtual Blackboard!
            </p>
